...
public class GuiAccountEditScreen extends GuiScreen {
    ...
    public GuiAccountEditScreen(GuiScreen parentScreen) {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, "Edit Account", this.width / 2, 17, 0xFFFFFFFF);
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.id == 0) {
            Account account = Exeter.getInstance().getAccountManager().getList()
                    .get(Exeter.getInstance().getAccountManager().getGuiAccountScreen().getAccountSlot()
                            .getSelectedAccount());
            account.setLabel(usernameField.getText());
    ...
    public void initGui() {
        ...
        buttonList.clear();
        buttonList.add(new GuiButton(0, this.width / 2 - 100, this.height / 4 + 96 + 18, "Save"));
        ...
        passwordField = new GuiTextField(1, fontRendererObj, this.width / 2 - 100, 106,
                200, 20);
        Account account = Exeter.getInstance().getAccountManager().getList().get(Exeter.getInstance().getAccountManager()
                .getGuiAccountScreen().getAccountSlot().getSelectedAccount());
        usernameField.setText(account.getLabel());
